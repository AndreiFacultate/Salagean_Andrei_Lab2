...
namespace Salagean_Andrei_Lab2.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Salagean_Andrei_Lab2Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Salagean_Andrei_Lab2Context context,
